function [addedRowIndex,addedHandles] = resizeFigureAndPanelForAddedControls(panel_h,lowest_tag_suffix_index,height_offset)
% [addedRowIndex,addedHandles] = resizeFigureAndPanelForAddedControls(panel_h,lowest_tag_suffix_index,height_offset)
%
% This function may be obsolete or a duplicate...
%
