%> @file detection_nn_simple
%> @brief Uses detection_rr_simple to find rr interval and then converts to
%> normalized interval (Based on beats).
%======================================================================
%> @brief Detects NN (normalized RR) intervals from ECG input.
%> @param data_cell Single element cell with ECG data vector
...
function detectStruct = detection_nn_simple(data_cell,params, stageStruct)
...
%    detectStruct = detection_rr_simple(params.filter_order);
