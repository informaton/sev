...
if(nargin<2 || isempty(params))
    ...
    if(exist(pfile,'file'))
        ...
        params.window_dur_min = 2; % Moving window duration in minutes
        params.window_overlap = 0.8; % Overlap moving window (0.8 = 80% overlap)
        params.recording_quality_threshold = 0.75; % If more than 75% of the recording is bad quality, exclude all
