function detectStruct = detection_plm_ferri_anc_and_hr(channel_indices, optional_params)
% detects PLM using dualthreshold method (see plm_ferri) with adaptive
% noise cancelling of ECG channel.  Additionally, HR is calculalated using
...
%
% Written by Hyatt Moore IV, 5/15/2012
...
lm_detectStruct = detection.detection_lm_ferri_with_anc(channel_indices,params);
